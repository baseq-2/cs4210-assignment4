...
# SPECIFICATION: Using a deep learning model to classify images of clothing
...
for layer in n_hidden:                          #looking or the best parameters w.r.t the number of hidden layers
    for neuron in n_neurons:                      #looking or the best parameters w.r.t the number of neurons
        for rate in l_rate:                  #looking or the best parameters w.r.t the learning rate
            ...
            model = build_model(layer, neuron, 10, rate)
            #-->add your Pyhton code here
            ...
            #-->add your Pyhton code here
            accuracy = 0
            for i, (x_testSample, y_testSample) in enumerate(zip(X_test, y_test)):
                if class_predicted[i] == y_testSample:
                    accuracy += 1
